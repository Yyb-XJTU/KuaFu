...
(cl:defmethod cl:initialize-instance :after ((m <V2X>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'V2X)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name V2X_pkg-msg:<V2X> is deprecated: use V2X_pkg-msg:V2X instead.")))

(cl:ensure-generic-function 'Yellow-val :lambda-list '(m))
(cl:defmethod Yellow-val ((m <V2X>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_pkg-msg:Yellow-val is deprecated.  Use V2X_pkg-msg:Yellow instead.")
  (Yellow m))

(cl:ensure-generic-function 'Red-val :lambda-list '(m))
(cl:defmethod Red-val ((m <V2X>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_pkg-msg:Red-val is deprecated.  Use V2X_pkg-msg:Red instead.")
  (Red m))

(cl:ensure-generic-function 'Black-val :lambda-list '(m))
(cl:defmethod Black-val ((m <V2X>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_pkg-msg:Black-val is deprecated.  Use V2X_pkg-msg:Black instead.")
  (Black m))
